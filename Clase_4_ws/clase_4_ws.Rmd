...
Se ve como este artículo parecen predominar palabras del tópico 2 (comidas, restaurantes). Veamos el texto completo de este documento:
```{r}
revistas %>%
  filter(id==2571) %>%
  select(text) %>%
...
Vemos cómo las revistas de mujeres parecen concentrarse en los tópicos 1 y 3, mientras que las de hombres, en los tópicos 2 y 4. Siendo el tópico 3 el menos relevante.
