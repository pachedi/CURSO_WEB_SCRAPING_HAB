...
write_lines(discurso, "./discursos/discurso.txt")
...
Vamos a descargar la información de un libro de F. Engels
...
tabla_final <- as.data.frame(cbind("Autor" = autor,"Biografi"=biografia,
                                   tabla_info2))
