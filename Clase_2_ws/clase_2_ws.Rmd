...
pagina <- "https://www.diariodepontevedra.es/tags/barcelona"
...
for(i in 1:max_pag){
 ...
 objeto <- read_html(paste0("https://www.diariodepontevedra.es/tags/buenos-aires/?page=",i))
...
links_completos <- paste0(raiz, links)
links_completos
```
...
cuerpo <- str_replace_all(cuerpo, "Tlfno", "")
